...
return(<>
    ...
    <h1 className="sev-loanHeader">START YOUR NEW LOAN APPLICATION</h1>
        ...
        <div className="decide-container">
            ...
            <button className="overDraft" ><FontAwesomeIcon className= 'overdraftIcon'icon={faHandHoldingDollar} size='2xl'style={{color: "#005F44"}} /> Overdraft</button>
            <button className="creditCard"> <FontAwesomeIcon className= 'creditCardIcon'icon={faCreditCard} size='2xl' style={{color: "#005F44"}} /> Credit Card</button>
            <button className="loan"><FontAwesomeIcon className="loanIcon" icon={faMoneyCheckDollar} size='2xl' style={{color: "#005F44"}} />Loan</button>
        ...
        <button className="backBtn"> <FontAwesomeIcon icon={faChevronLeft} /> Back</button>
